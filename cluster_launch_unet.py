...
def main():
    ...
    base_bsub_command = f'bsub -n 4 -gpu "num=1" -q gpu_rtx -W 600'
    base_python_command = f'python code/main_unet.py -b 32'
    ...
    for model_path in model_paths:
        ...
        python_command = f'{base_python_command} --pretrained {checkpoint} ' \
                         + f'{DATA_DIR} {save_dir} {AUG_FILE}'
        bsub_command = f'{base_bsub_command} -J {save_name} -o {output_file} ' \
                       + f'-e {error_file} "{python_command}"'
